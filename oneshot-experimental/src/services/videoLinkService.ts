...
import { mediaItems, mediaTypeEnum } from '../db/schema/mediaItems';
  ...
  return db.select()
    ...
    .where(
      and(
        ...
        eq(mediaItems.mediaType, mediaTypeEnum.enumValues.indexOf('highlight_video') as any) ||
        eq(mediaItems.mediaType, mediaTypeEnum.enumValues.indexOf('game_film') as any) ||
        eq(mediaItems.mediaType, mediaTypeEnum.enumValues.indexOf('training_clip') as any)
      )
    );
}
