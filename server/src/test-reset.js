...
async function testPasswordResetFlow() {
  try {
    ...
    const validEmail = 'athlete@oneshot.com'; // Should exist from seeding
    ...
    // Step 4: Test password reset with non-existent email
    console.log('\n4. Testing password reset with non-existent email:');
